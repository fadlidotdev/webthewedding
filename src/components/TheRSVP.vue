...
<template>
  ...
  >
    <div class="space-y-1 text-center" data-aos="fade-down">
      <h2 class="text-4xl">RSVP</h2>
      <p class="text-sm opacity-75">Your wish are very mean to us.</p>
    </div>

    <form
      class="flex flex-col w-3/4 gap-2 p-4 my-4 rounded-lg bg-primary-foreground/50"
    ...
    >
      ...
      <label class="flex items-center gap-2" htmlFor="belum_hadir">
        <input type="radio" name="kehadiran" id="belum_hadir" value="0" v-model="attendance" />
      ...
      <button
        class="h-10 px-4 mt-3 text-sm text-white border rounded-lg shadow-xl bg-primary border-primary"
      >
        Kirim
      </button>
    </form>
    ...
    <div
      class="flex flex-col w-3/4 gap-2 mb-16 overflow-auto max-h-80"
      data-aos="fade-up"
      data-aos-delay="500"
    >
      <div
        v-for="rsvp in rsvps"
        :key="rsvp.id"
        class="p-3 text-white rounded-lg bg-primary-foreground/50"
      >
        <div class="flex items-center gap-2 mb-2">
          ...
          <div
            :class="[
              'block px-2 py-1 text-xs rounded-full',
              rsvp.attendance ? 'bg-primary' : 'bg-primary-foreground'
            ]"
          >
    ...
    <div class="mb-6 space-y-1 text-center" data-aos="fade-in" data-aos-offset="400">
    ...
    <!-- Ornaments -->
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute left-0 w-16 rotate-45 -top-8"
      alt=""
    />
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute right-0 w-16 rotate-45 -top-8"
      alt=""
    />
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute -top-8 left-[15%] w-16 rotate-45"
      alt=""
    />
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute -top-8 left-[30%] w-16 rotate-45"
      alt=""
    />
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute -top-8 right-[15%] w-16 rotate-45"
      alt=""
    />
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute -top-8 right-[30%] w-16 rotate-45"
      alt=""
    />
    <img
      src="/ornaments/ornament-orange-flower.png"
      class="absolute -top-8 right-[40%] w-16 rotate-45"
      alt=""
    />
  </section>
</template>
