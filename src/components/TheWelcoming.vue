...
<template>
  <section
    class="section-hero-2 gap-8 min-h-[100vh] flex flex-col items-center justify-center text-center"
  >
    <h1
      data-aos="fade-down"
      data-aos-delay="500"
      class="text-primary font-display text-7xl"
    ...
    <div class="flex flex-col items-center space-y-8">
      <p class="px-4" data-aos="zoom-in" data-aos-delay="750">
        We invited you to celebrate our Wedding <br />
        Sabtu, 27 April 2024
      </p>

      <div class="flex gap-4" data-aos="fade-up" data-aos-delay="1000">
        <div
